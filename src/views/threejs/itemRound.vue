...
export default {
  ...
  methods: {
    init() {
      ...
      // 物体旋转，根据xyz轴旋转.rotation.xyz
      // 当xyz轴一起同时旋转的时候，会出现万向锁，axis不在工作，需要设置xyz轴的旋转顺序object.rotation.reorder("YXZ"),YXZ是执行的旋转顺序
      this.mesh2.rotation.reorder('YXZ') // 旋转顺序
      this.mesh2.rotation.x = Math.PI / 4 // 物体绕着X轴旋转45°
      this.mesh2.rotation.y = Math.PI / 4 // 物体绕着Y轴旋转45°
      this.mesh2.rotation.Z = Math.PI / 4 // 物体绕着Z轴旋转45°
    },
    animate() {
      // 递归调用自身以实现动画效果
