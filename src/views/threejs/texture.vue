...
export default {
  ...
  methods: {
    init() {
      ...
      // 加载纹理
      const texture = textureLoader.load(require('/public/img/map.png'))
      // 加载ao贴图
      const aoMap = textureLoader.load(require('/public/img/aomap.png'))
      // // 设置平面材质
      ...
      // 透明度贴图
      const alphaMap = textureLoader.load(require('/public/img/displacementMap.png'))
      const planeMaterial = new THREE.MeshBasicMaterial({
        color: 0xffffff,
        map: texture, // 贴图
        transparent: true, // 允许透明度
